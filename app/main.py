...
tags_metadata = [
    ...
    },
    {
        "name": "LLM",
        "description": (
            "Cloud code-generation endpoint backed by OpenRouter (with legacy Bedrock "
            "fallback), protected by Bearer auth, prompt guard checks, rate limiting, and output validation."
        ),
    },
    {
        "name": "AI Context",
